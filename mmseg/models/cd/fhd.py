...
class FHD_Head(BaseDecodeHead):
    def __init__(self, feature_strides, **kwargs):
        ...
        self.fhd1 = FHD_Module(channels=c1_in_channels, r=c1_in_channels // 16)
        self.fhd2 = FHD_Module(channels=c2_in_channels, r=c2_in_channels // 16)
        self.fhd3 = FHD_Module(channels=c3_in_channels, r=c3_in_channels // 16)
        self.fhd4 = FHD_Module(channels=c4_in_channels, r=c4_in_channels // 16)
